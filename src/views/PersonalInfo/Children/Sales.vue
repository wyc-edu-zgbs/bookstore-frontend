<template>
    <el-container style="height: 100%; width: 100%; border: 0px">
        <el-header style="text-align: left; font-size: 20px; display: flex; justify-content: space-between;">
            ...
            <el-button class="emptytrash" type="success" @click.native="selectnew()">
        ...
        <el-main>
        <el-table :data="order" height=666px style="width: 100%" :default-sort = "{prop: 'date', order: 'descending'}" 
...
<el-row :gutter="20" style="margin-top:20px">
  <el-col v-for="item in scope.row.items.slice(0,2)" :key=item.id :span="6">
              <div  >
                  <img :src="item.cover | media2url" width="40" height="40">
              </div>

              
              </el-col>
              <el-col v-if='scope.row.items.length>2' :span="6">
                         <i  class="el-icon-more" style="margin-top:10px;margin-left:10px"></i>
              </el-col>
