<template>
 <el-container>
            <el-card class="main">
                <div>
                    <el-avatar class="bigpic" :size="200" :src="userInfo.avatar" style="margin-right: 20px"></el-avatar>
                    <!--
                ...
                <div class="message">
                    ...
                    <p v-if="userInfo.nickname !== null">昵称:  {{userInfo.nickname}} <el-link @click.native="dialog6 = true" type="primary" icon="el-icon-edit" style="margin-bottom: 2.8px"></el-link></p>
                    <p v-else>昵称:  <el-link @click.native="dialog6 = true" type="primary" icon="el-icon-edit" style="margin-bottom: 2.8px">马上填写</el-link>您的昵称，让更多的人了解你</p>

                    <p v-if="userInfo.gender !== null">性别:  {{userInfo.gender == 0 ? '男' : '女'}}
                         <el-link @click.native="dialog1 = true" type="primary" icon="el-icon-edit" style="margin-bottom: 2.8px"></el-link></p>
                    ...
                    <p v-if="userInfo.age !== null">年龄:  {{userInfo.age}} <el-link @click.native="dialog2 = true" type="primary" icon="el-icon-edit" style="margin-bottom: 2.8px"></el-link></p>
                    ...
                    <p>电话:  {{userInfo.phone}} <el-link @click.native="dialog5 = true" type="primary" icon="el-icon-edit" style="margin-bottom: 2.8px"></el-link></p>
                    <p v-if="userInfo.qq !== null">QQ:  {{userInfo.qq}} <el-link @click.native="dialog3 = true" type="primary" icon="el-icon-edit" style="margin-bottom: 2.8px"></el-link></p>
                    ...
                    <p v-if="userInfo.address !== null">地址:  {{userInfo.address}} <el-link @click.native="dialog4 = true" type="primary" icon="el-icon-edit" style="margin-bottom: 2.8px"></el-link></p>
        ...
        <el-dialog title="提示" :visible.sync="dialog5" width="30%">
         ...
         <el-dialog title="提示" :visible.sync="dialog6" width="30%">
            <div style="margin-bottom: 20px">
                <span>您的昵称:</span>
            </div>
            <el-form ref="nicknameFormRef" :model="nicknameForm" label-width="0px" class="nickname_form">
                <el-form-item prop="nickname">
                    <el-input placeholder="nickname:" v-model="nicknameForm.nickname"></el-input>
                </el-form-item>
            </el-form>
            <span slot="footer" class="dialog-footer">
                <el-button @click="dialog6 = false">取 消</el-button>
                <el-button type="primary" @click.native="nickname()">确 定</el-button>
            </span>
        </el-dialog>
